...
<head>
	<c:import url="../common/commonUtil.jsp">
		<c:param name="titleName" value="이용약관 페이지"/>
	</c:import>
</head>
						...
						<!--  -->
							...
							<p class="stext-117 cl6 p-b-26">
								...
								1. 가입 신청 시에 허위 내용을 등록한 경우
									<br /><br />
								2.&nbsp;&nbsp;“몰”&nbsp;&nbsp;을 이용하여 구입한 재화 등의 대금, 기타 &nbsp;&nbsp;“몰”&nbsp;&nbsp;이용에 관련하여 회원이 부담하는 채무를 기 일에 지급하지 않는 경우
									<br /><br />
							...
							<h5 class="p-t-40">
 							...
 							<p class="stext-117 cl6 p-b-26">
								...
								6. 결제방법의 선택
									<br /><br />
								② &nbsp;&nbsp;“몰”&nbsp;&nbsp;이 제3자에게 구매자 개인정보를 제공할 필요가 있는 경우 1) 개인정보를 제공받는 자, 2)개인정보를 제공받는 자의 개인정보 이용목적, 3) 제공하는 개인정보의 항목, 4) 개인정보를 제공받는 자의 개인정보 보유 및 이용기간을 구매자에게 알리고 동의를 받아야 합니다. <br />(동의를 받은 사항이 변경되는 경우에도 같습니다.)
									<br /><br />
							...
							<h5 class="p-t-40">
 							...
 							<p class="stext-117 cl6 p-b-26">
								...
								⑤ &nbsp;&nbsp;“몰”&nbsp;&nbsp;이 제2항과 제3항에 의해 이용자의 동의를 받아야 하는 경우에는 개인정보관리 책임자의 신원(소속, 성명 및 전화번호, 기타 연락처), 정보의 수집목적 및 이용목적, 제3자에 대한 정보제공 관련사항(제공받은자, 제공목적 및 제공할 정보의 내용) 등 「정보통신망 이용촉진 및 정보보호 등에 관한 법률」 제22조제2항이 규정한 사항을 미리 명시하거나 고지해야 하며 이용자는 언제든지 이 동의를 철회할 수 있습니다.
									<br /><br />  
								⑥ &nbsp;&nbsp;이용&nbsp;&nbsp;자는 언제든지 &nbsp;&nbsp;“몰”&nbsp;&nbsp;이 가지고 있는 자신의 개인정보에 대해 열람 및 오류정정을 요구할 수 있으며 &nbsp;&nbsp;“몰”&nbsp;&nbsp;은 이에 대해 지체 없이 필요한 조치를 취할 의무를 집니다. 이용자가 오류의 정정을 요구한 경우에는 “몰”은 그 오류를 정정할 때까지 당해 개인정보를 이용하지 않습니다.
									<br /><br />  
