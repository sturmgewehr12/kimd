...
<body>
	...
	<section class="sec-product-detail bg0 p-t-65 p-b-60">
		<div class="container">
			<form onsubmit="return insertbtn();" action="${ pageContext.request.contextPath }/product/productUpdate.do?goodsNo=${goods.goodsNo}" method="post" enctype="multipart/form-data" id="updateForm">
			<div class="row">
				...
				<div class="bor10 col-md-6 col-lg-5 p-b-30">
					<div class="p-r-50 p-t-30 p-lr-0-lg">
						<div class="flex-w flex-r-m p-b-10">
								...
								<div class="size-204 respon6-next">
									<h4 class="mtext-105 cl2 js-name-detail p-b-14">
										<input class="size-111 bor8 stext-102 cl2 p-lr-20" type="text" name="gName" value="${goods.gName}"/>
									</h4>
								</div>
							</div>
						...
						<div class="flex-w flex-r-m p-b-10">
							...
							<div class="size-204 respon6-next">
								<h4 class="mtext-105 cl2 js-name-detail p-b-14">
									<input class="size-111 bor8 stext-102 cl2 p-lr-20" type="number" name="gPrice" value="1000" min="1000" step="100" value="${goods.gPrice}"/>
								</h4>
							</div>
						</div>
						<div class="flex-w flex-r-m p-b-10">
							...
							<div class="size-204 respon6-next">
								<h4 class="mtext-105 cl2 js-name-detail p-b-14">
									<input class="size-111 bor8 stext-102 cl2 p-lr-20" type="text" name="gColor" value="${goods.gColor}"/>
								</h4>
							</div>
						</div>
						<div class="flex-w flex-r-m p-b-10">
							...
							<div class="size-204 respon6-next">
								<h4 class="mtext-105 cl2 js-name-detail p-b-14">
									<input class="size-111 bor8 stext-102 cl2 p-lr-20" type="text" name="gSize" value="${goods.gSize}"/>
								</h4>
							</div>
						</div>
						...
						<div class="flex-w flex-r-m p-b-10">
							<div class="col-12 p-b-5">
								...
								<input class="size-111 bor8 stext-102 cl2 p-lr-20" id="gEtc" type="text" name="gSimple" placeholder="간단 설명 (EX. 옷의 재질등과 이염 여부)" value="${goods.gSimple }"/>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="flex-w flex-r-m p-b-10">
					<div class="col-12 p-b-5">
		              ...
		              <div class="editorArea" style="margin-top:20px;">
		                  <textarea id="summernote" name="gDetail">
		                  ${goods.gDetail}</textarea>
		              </div>
						<br>
		              <div align="center">
		                  <button type="submit" class="btn btn-primary">수정 완료</button>
		                  <button type="reset" class="btn btn-primary" onclick="cancelbtn();">취소</button>
		                  <input type="submit" class="btn btn-outline-info" id="godelete" value="삭제 하기" formaction="${pageContext.request.contextPath }/product/productDelete.do?goodsNo=${goods.goodsNo}" />
		              </div>
                    </div>
               </div>
			</div>
