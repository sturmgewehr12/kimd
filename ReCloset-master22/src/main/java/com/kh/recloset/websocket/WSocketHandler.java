package com.kh.recloset.websocket;
...
//    	// 이 빈 괄호안에 session.getId()가 자동으로 들어감
...
//            // 다른사람일때는 메세지 출력 / getUserName으로 붙이면 사용자 이름으로 
//            one.sendMessage(new TextMessage(loggin.getUserId()+"님이 입장하셨습니다."));
//        }
//        
...
//        // getPayload() : 메세지에 담긴 문자열, getRemoteAddress() : 보낸사람의 IP, 
//    }
//
//    
//    // 사용자가 연결을 종료했을때 동작하는 메소드 
//    @Override
